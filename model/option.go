...
func InitOptionMap() {
	...
	common.OptionMap["KolCommissionRate"] = strconv.FormatFloat(setting.KolCommissionRate, 'f', -1, 64)
	common.OptionMap["StripeConnectEnabled"] = strconv.FormatBool(setting.StripeConnectEnabled)
	common.OptionMap["MinWithdrawalAmount"] = strconv.FormatFloat(setting.MinWithdrawalAmount, 'f', -1, 64)
	common.OptionMap["StripeConnectClientId"] = setting.StripeConnectClientId
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "KolCommissionRate":
		setting.KolCommissionRate, _ = strconv.ParseFloat(value, 64)
	case "StripeConnectEnabled":
		setting.StripeConnectEnabled = value == "true"
	case "MinWithdrawalAmount":
		setting.MinWithdrawalAmount, _ = strconv.ParseFloat(value, 64)
	case "StripeConnectClientId":
		setting.StripeConnectClientId = value
	case "CreemApiKey":
